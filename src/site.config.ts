...
const config: SiteConfig = {
  ...
  site: 'https://blog.740222.xyz',
  // The name of your site, used in the title and for SEO.
  title: 'ReBlog',
  // The description of your site, used for SEO and RSS feed.
  description:
    'Retrieve0’s personal blog on web design, front-end development, Python utilities, reverse engineering, and Minecraft datapacks and resource packs.',
  // The author of the site, used in the footer, SEO, and RSS feed.
  author: 'Retrieve0',
  // Keywords for SEO, used in the meta tags.
  tags: ['Retrieve0', '前端开发', 'Vue', 'Astro', 'JavaScript', 'Python', 'Minecraft 数据包'] ,
  ...
  socialLinks: {
    github: 'https://github.com/lost0427',
    mastodon: '@lost0427:chat.neboer.site',
    email: 'mailto:cake-rewrap-humid@duck.com',
    linkedin: '',
    bluesky: '',
    twitter: '',
